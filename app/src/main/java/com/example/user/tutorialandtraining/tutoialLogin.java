...
public class tutoialLogin extends AppCompatActivity {
    private Button b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutoial_login);
        ...
        t.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(tutoialLogin.this,tutorialReg.class);
                startActivity(i);
            }
        });
        ...
        if (!TextUtils.isEmpty(email)  && !TextUtils.isEmpty(pass))
        {
            mAuth.signInWithEmailAndPassword(email,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    {
                        Toast.makeText(tutoialLogin.this,"Invaild email and password",Toast.LENGTH_SHORT).show();
                    }
    ...
    public  void  checkuserlist()
    {
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    Toast.makeText(tutoialLogin.this,"success log in",Toast.LENGTH_SHORT).show();
                ...
                {
                    Toast.makeText(tutoialLogin.this,"need registration..",Toast.LENGTH_SHORT).show();
                }
