...
public class trainingReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_training_reg);
        ...
        mauth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(trainingReg.this, "success registration..", Toast.LENGTH_LONG).show();

                    Intent i = new Intent(getApplicationContext(), trainingLogin.class);
                    startActivity(i);
                    ...
                    Toast.makeText(trainingReg.this, "already registered..Go login..", Toast.LENGTH_LONG).show();
                }
