...
public class tutorialReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial_reg);
        ...
        mauth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(tutorialReg.this, "success registration..", Toast.LENGTH_LONG).show();

                    Intent i = new Intent(getApplicationContext(), tutoialLogin.class);
                    startActivity(i);
                    ...
                    Toast.makeText(tutorialReg.this, "already registered..Go login..", Toast.LENGTH_LONG).show();
                }
