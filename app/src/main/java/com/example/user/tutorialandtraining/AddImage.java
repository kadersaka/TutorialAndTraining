...
public class AddImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPrograssbar=findViewById(R.id.prograssbarid);
        ...
        b2image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mUploadtask!=null)
                {
                    Toast.makeText(AddImage.this,"upload is progress",Toast.LENGTH_LONG).show();
        ...
        if (mImageUri!=null)
        {
            ...
            mUploadtask= fileReference.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(AddImage.this,"success upload",Toast.LENGTH_LONG).show();
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AddImage.this,e.getMessage(),Toast.LENGTH_LONG).show();
                ...
                public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    mPrograssbar.setProgress((int)prograss);
